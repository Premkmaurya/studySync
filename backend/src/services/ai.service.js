...
<h2 style="text-align: center;">[Generated Title Here]</h2><p>[Introductory Paragraph]</p><ul><li>[First key point]</li><li>[Second key point]</li></ul>
If the user explicitly asks for 'more data', 'continue', or 'more points', ONLY provide the next set of raw HTML tags to be appended, such as more <p> tag rather than <li> tags. Do not include a title or repeat previous content.`;
