    ...
    >
      ...
      <main className="relative z-10 pt-28 pb-32 px-6">
        <section className="max-w-7xl mx-auto text-center mb-40">
          ...
          >
            A complete infrastructure for professional collective knowledge
            management, optimized for speed and high-density technical syncing.
          </motion.p>
        </section>
        ...
        <section
          className={`relative py-18 border-y rounded-[80px] transition-colors ${
            theme === "light"
        ...
        >
          <div className="max-w-5xl mx-auto text-center mb-10 px-6">
            ...
            >
              Automating communication in Slack, scheduling via Calendar, and
              syncing intelligence across your ecosystem.
            </p>
          </div>
