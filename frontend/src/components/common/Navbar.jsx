  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-[8px] bg-[#0075de] text-white flex items-center justify-center shadow-sm group-hover:scale-105 group-hover:bg-[#097fe8] transition-all duration-200">
        ...
        <div className="hidden md:flex items-center gap-2 bg-black/[0.03] p-1 rounded-[12px] border border-black/[0.04]">
          ...
          <div className="pl-1">
            {!user ? (
              <Link
                to="/register"
                className="group inline-flex items-center justify-center gap-1.5 px-8 py-2 bg-[#05080d] hover:bg-[#151c28] active:bg-[#000000] text-white text-[13px] font-semibold rounded-[10px] transition-all duration-200 shadow-sm hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0075de]"
              >
                <span>Get started</span>
                <ArrowRight className="w-3 h-3 text-white/90 transition-transform duration-200 group-hover:translate-x-1" aria-hidden="true" />
              </Link>
            ) : (
              <Link
                to="/home"
                className="group inline-flex items-center justify-center gap-1.5 px-8 py-2 bg-[#0075de] hover:bg-[#097fe8] active:bg-[#0060b8] text-white text-[13px] font-semibold rounded-[10px] transition-all duration-200 shadow-sm hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0075de]"
              >
                <span>Dashboard</span>
                <ArrowRight className="w-3 h-3 text-white/90 transition-transform duration-200 group-hover:translate-x-1" aria-hidden="true" />
              </Link>
