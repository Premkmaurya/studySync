          ...
          {isOpen && (
            ...
            >
              ...
              <div className="flex flex-col gap-8">
                {navItems.map((item, index) => (
                  ...
                  >
                    ...
                    >
                      {item.label}
                      <ArrowRight size={24} className="text-indigo-500 opacity-0 group-hover:opacity-100 transition-opacity" />
                    </Link>
                  </motion.div>
                ))}
                ...
                >
                  <Link
                    to="/login"
                    className="flex items-center justify-center w-full py-6 bg-white text-black text-xs font-black uppercase tracking-[0.3em] rounded-3xl shadow-2xl hover:bg-indigo-500 hover:text-white transition-all active:scale-95"
                  >
                    Login
                  </Link>
                </motion.div>
              ...
              <div className="mt-auto pb-12">
                <div className="flex items-center gap-4 text-[9px] font-black text-zinc-700 tracking-[0.4em] uppercase">
