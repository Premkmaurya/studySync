...
const cardData = [
  {
    ...
    description:
      "Work together on notes instantly with live syncing across all devices.",
    label: "Collaboration",
    img: "/img/powered-by.avif",
  },
  {
    color: "#fff",
    title: "Lightning-Fast Note Syncing",
    description:
      "Your notes update in real time—no refresh, no delay, just instant sync.",
    label: "Performance",
    img: "/img/response.avif",
  },
  {
    color: "#fff",
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid gap-2 p-2 w-full max-w-full select-none relative"
