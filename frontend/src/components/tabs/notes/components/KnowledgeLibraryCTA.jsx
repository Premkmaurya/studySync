...
/**
 * KnowledgeLibraryCTA
 * Restrained bottom CTA inviting users to keep building their personal knowledge repository.
 */
const KnowledgeLibraryCTA = () => {
  return (
    <section className="mt-16 pt-10 px-1 sm:px-5 border-t border-black/[0.08]">
      <div className="bg-white rounded-[20px] border border-black/[0.08] p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6 shadow-2xs">
        ...
        <div className="space-y-1 max-w-xl">
          ...
          <p className="text-[13px] sm:text-[14px] text-[#615d59] leading-relaxed font-sans">
            Join a study group, learn something new with peers, and capture it in your knowledge library.
          </p>
        </div>
...
export default KnowledgeLibraryCTA;
