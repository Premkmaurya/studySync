 ...
 * Sticky control bar containing search input and category filter pill triggers for the Knowledge Library.
 */
const StickyNotesSearchFilter = ({
  searchTerm,
  setSearchTerm,
  selectedCategory,
  setSelectedCategory,
  ...
  return (
    <div className="sticky top-18 sm:top-20 z-30 bg-[#f6f5f4]/95 backdrop-blur-md py-3.5 border-b border-black/[0.08] mb-8 transition-all">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1 lg:pb-0 scrollbar-none shrink-0" aria-label="Filter notes by category">
          {CATEGORIES.map((cat) => {
...
export default StickyNotesSearchFilter;
