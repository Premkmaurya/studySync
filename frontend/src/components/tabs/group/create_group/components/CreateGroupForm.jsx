      ...
      <div className="lg:col-span-5 space-y-6">
        <div className="bg-zinc-900/40 backdrop-blur-3xl border border-white/5 rounded-[40px] p-8 shadow-2xl relative overflow-hidden group">
          ...
          <div className="relative aspect-square w-full max-w-60 mx-auto">
            <div
              className={`w-full h-full rounded-[48px] border-2 border-dashed border-white/10 flex flex-col items-center justify-center transition-all overflow-hidden ${imagePreview ? "border-solid border-indigo-500/50 shadow-[0_0_40px_rgba(99,102,241,0.2)]" : "hover:border-white/20"}`}
            >
              {imagePreview ? (
                <>
                  <img
        ...
        <div className="bg-zinc-900/40 backdrop-blur-3xl border border-white/5 rounded-[40px] p-6 shadow-2xl space-y-10">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-transparent text-2xl tracking-tighter text-white placeholder:text-zinc-800 outline-none border-b-2 border-white/5 focus:border-indigo-500 transition-all pb-1"
              />
              {errors.name && (
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-4 text-sm font-bold outline-none appearance-none focus:border-indigo-500/50 transition-all text-white"
                >
                  <option value="" disabled selected className="bg-zinc-900">
                    Select Domain
                  </option>
                  <option value="Engineering" className="bg-zinc-900">
                    Web Engineering
                  </option>
          ...
          <div className="space-y-4">
            ...
            <textarea
              ...
              className="w-full bg-white/5 border border-white/10 rounded-3xl py-3 px-5 text-sm outline-none focus:border-indigo-500/50 transition-all resize-none placeholder:text-zinc-700 text-white"
            />
          </div>
