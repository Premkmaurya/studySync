 ...
 * Student-focused conversational UI panel with clear student language.
 */
      ...
      <div className="grid grid-cols-1 px-6 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="flex flex-col gap-2">
              {sampleConversations.map((item, idx) => (
                <button
                  ...
                  className={`text-left text-[13px] px-3.5 py-2.5 rounded-[8px] border transition-all duration-150 flex items-center justify-between ${
        ...
        <div className="lg:col-span-7">
          <div className="w-full rounded-[12px] bg-white border border-black/[0.08] p-6 shadow-[0_4px_24px_rgba(0,0,0,0.04)] text-left flex flex-col justify-between min-h-[380px]">
            ...
            <div className="flex items-center justify-between pb-4 border-b border-black/[0.06] mb-6">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-[6px] bg-[#02093a] text-white flex items-center justify-center">
              ...
              <span className="inline-flex items-center gap-1 text-[11px] font-mono text-[#0075de] bg-[#e6f3fe] px-2.5 py-0.5 rounded-full">
                <span className="w-1.5 h-1.5 rounded-full bg-[#0075de] animate-pulse" /> Live Support
              </span>
            </div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex justify-end">
                <div className="bg-[#0075de] text-white text-[13.5px] px-4 py-2.5 rounded-[12px] rounded-tr-none max-w-[85%] leading-relaxed shadow-sm">
              ...
              <div className="flex items-start gap-3 justify-start">
                <div className="w-7 h-7 rounded-full bg-[#e6f3fe] text-[#0075de] flex items-center justify-center shrink-0 mt-1 border border-[#0075de]/20">
            ...
            <div className="relative flex items-center bg-[#f6f5f4] rounded-[8px] p-2 border border-black/[0.08] focus-within:border-[#0075de] transition-colors">
              ...
              <button 
                ...
                className="w-8 h-8 rounded-[6px] bg-[#0075de] text-white flex items-center justify-center shrink-0 hover:bg-[#097fe8] transition-colors"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
            <div className="bg-white rounded-[10px] p-4 border border-black/[0.06] flex items-start gap-3">
              <div className="w-7 h-7 rounded-[6px] bg-[#e6f3fe] text-[#0075de] flex items-center justify-center shrink-0 mt-0.5">
                <Lightbulb className="w-3.5 h-3.5" />
              </div>
              <div>
                <h4 className="text-[13px] font-bold text-[#000000]">Understand</h4>
                <p className="text-[12px] text-[#615d59]">Break down difficult concepts into simple terms.</p>
              </div>
            </div>

            <div className="bg-white rounded-[10px] p-4 border border-black/[0.06] flex items-start gap-3">
              <div className="w-7 h-7 rounded-[6px] bg-[#fff4cc] text-[#e89d01] flex items-center justify-center shrink-0 mt-0.5">
                <HelpCircle className="w-3.5 h-3.5" />
              </div>
              <div>
                <h4 className="text-[13px] font-bold text-[#000000]">Explore</h4>
                <p className="text-[12px] text-[#615d59]">Ask follow-up questions and test your memory.</p>
              </div>
            </div>

            <div className="bg-white rounded-[10px] p-4 border border-black/[0.06] flex items-start gap-3">
              <div className="w-7 h-7 rounded-[6px] bg-[#0075de]/10 text-[#0075de] flex items-center justify-center shrink-0 mt-0.5">
                <BookOpen className="w-3.5 h-3.5" />
              </div>
              <div>
                <h4 className="text-[13px] font-bold text-[#000000]">Learn</h4>
